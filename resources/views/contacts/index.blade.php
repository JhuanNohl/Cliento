    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Pessoas-chave para relacionamento e prospecção.</p>
            </div>
                    ...
                    @forelse ($contacts as $contact)
                        <div class="grid gap-4 px-6 py-5 lg:grid-cols-12 lg:items-center">
                            <div class="lg:col-span-3">
                                ...
                                <p class="text-sm text-gray-500">{{ $contact->role ?: 'Cargo não informado' }}</p>
                            </div>
                            ...
                            <p class="text-sm text-gray-600 lg:col-span-2">{{ $contact->last_contacted_at?->format('d/m/Y') ?? 'Sem último contato' }}</p>
