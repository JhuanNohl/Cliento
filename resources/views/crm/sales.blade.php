...
@section('content')
    <section class="page-head">
        <div>
            ...
            <h1>Negocios ganhos fecham o ciclo entre relacionamento e receita.</h1>
            <p class="lead">A área de vendas mostra o que virou contrato, o que está em implantação e quais renovações merecem atenção. É o MVP provando valor no caixa.</p>
        </div>
    </section>

    <section class="metrics-grid">
        <x-crm.metric label="Vendas do mês" value="R$ 238k" note="7 negócios fechados" icon="shopping-cart" />
        <x-crm.metric label="Ticket médio" value="R$ 34k" note="Base B2B validada" icon="tag" />
