...
@section('content')
    <section class="page-head">
        <div>
            ...
            <p class="lead">O MVP acompanha volume, conversão e tarefas pendentes. Relatórios customizáveis entram como camada futura.</p>
        </div>
    </section>
    ...
    <section class="metrics-grid">
        ...
        <x-crm.metric label="Ciclo medio" value="18d" note="Da entrada ao fechamento" icon="time" />
    ...
    <section class="page-grid">
        <article class="panel">
            <div class="panel-header">
                <div>
                    ...
                    <p>Visão simples para a primeira versão.</p>
                </div>
            </div>
            <div class="kanban">
                <x-crm.stage title="Entrada" count="14" value="R$ 74k" />
                <x-crm.stage title="Qualificacao" count="8" value="R$ 96k" />
        ...
        <aside class="panel">
            <div class="panel-header">
                <div>
                    <h2>Depois do MVP</h2>
                    <p>BI embarcado, cohort, funil por canal, metas por equipe e alertas preditivos.</p>
                </div>
            </div>
